    ...
    <>
        <div id='blogContainer' className={be_Vietnam_Pro.className}>
            <div className='blogContent'>
                ...
                <div id = 'h1Tags' className={pixelify_Sans_Bold.className}>&lt;h1&gt;</div> FUN FACT, I  <div id = 'blueTag' className={pixelify_Sans_Bold.className}> DO </div> HAVE A LIFE MY COMPUTER !
