...
export default function Hero(){
    return(
        <div>
            ...
            {/* Disc*/}
            <p id = "personalDisc" className={be_Vietnam_Pro_VLight.className}> <span id = 'pTags' className={pixelify_Sans.className}>&lt;p&gt;</span> Etiam aliquam libero pretium magna vehicula, eu porta risus sollicitudin. 
